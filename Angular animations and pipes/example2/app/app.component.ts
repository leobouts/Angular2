...
animations: [
  trigger('anm', [
    state('state1', style({backgroundColor: 'green',transform: 'translateX(50px) scale(1)' })),
    state('state2',   style({backgroundColor: 'yellow', transform: 'translate(85px,150px) scale(0.5) rotate(-20deg) skew(20deg, 10deg) ' })),
